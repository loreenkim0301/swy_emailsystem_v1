/*
  # Add sample blog data for websites and blog posts

  1. New Data
    - Website category blogs (7 entries)
      - 2 published websites (EmailJS tool, OpenAI tool)  
      - 5 coming-soon Bolt.new projects
    - Blog category posts (4 entries)
      - JavaScript email tutorial
      - Bolt.new advanced features
      - Supabase database guide
      - AI coding for planners

  2. Conflict Resolution
    - Handle slug conflicts with ON CONFLICT (slug)
    - Update existing records if slug already exists
