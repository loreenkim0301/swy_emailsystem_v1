...
-- 기존 데이터가 있으면 건너뛰고, 없으면 추가
DO $$
BEGIN
  -- 1. EmailJS 학습 도구 (출시됨)
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 1) THEN
    INSERT INTO blogs (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 2) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 3) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 4) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 5) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 6) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 7) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 8) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 9) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 10) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
  ...
  IF NOT EXISTS (SELECT 1 FROM blogs WHERE id = 11) THEN
    INSERT INTO blogs (
      id, title, description, content, category, status, featured, keywords, 
      view_count, slug, meta_title, meta_description, url, published_at
    ) VALUES (
